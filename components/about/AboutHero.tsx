...
const STORIES = [
  {
    ...
    body: "V1TR0 nació en 2024 desde el suroccidente colombiano con una convicción: que la tecnología de vanguardia no debería ser exclusiva de las grandes ciudades. Desde Popayán, decidimos construir soluciones que transforman organizaciones locales con herramientas de talla mundial.",
    tag: "Sur de Colombia · 2024",
    icon: (
    ...
    stat: { value: "2024", label: "Fundación" },
  },
  {
    id: "mision",
    tab: "Misión",
