      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-gradient-to-tr from-transparent via-[#00334455] to-transparent opacity-0 transition-opacity duration-500"
              style={{
                opacity: isHovering ? 0.4 : 0,
                backgroundSize: "150% 150%", // Más pequeño que el original (200%)
          ...
          >
            ...
            <div
              ...
              style={{
                opacity: isHovering ? 0.4 : 0,
                backgroundSize: "150% 150%", // Más pequeño que el original
                animation: "moveGradient 3s ease infinite alternate",
              }}
            />
