...
export default function TaskAutomationPage() {
  const serviceData = {
    ...
    description:
      "Optimizamos tus procesos empresariales mediante la automatización inteligente, liberando tiempo valioso y reduciendo errores humanos para maximizar la eficiencia operativa.",
    features: [
      {
    ...
    imageSrc:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Automatizaci%C3%B3n%20de%20tareas%20y%20reportes%20de%20An%C3%A1lisis%20y%20Visualizaci%C3%B3n%20de%20datos-viab5oAiUjBu7Jqw8XW9WrWKWlDUyy.png",
