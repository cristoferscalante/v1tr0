    ...
    <section className="min-h-screen lg:min-h-screen w-full px-4 py-8 lg:py-16 flex items-center bg-transparent">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 lg:pr-12">
          ...
          <motion.p className="text-textMuted text-lg mb-8" initial="hidden" animate="visible" variants={textVariant}>
            {description}
          </motion.p>
          ...
          >
            {features.map((feature, index) => (
              <motion.div key={index} className="flex items-center space-x-3" variants={textVariant}>
          ...
          >
            <button
              ...
              className={`${isDark ? "bg-[#02505931] backdrop-blur-sm" : "bg-[#e6f7f6] backdrop-blur-sm"} rounded-2xl border ${isDark ? "border-[#08A696]/20" : "border-[#08A696]/30"} transition-all duration-300 transform scale-95 hover:scale-100 hover:border-[#08A696] ${isDark ? "hover:bg-[#02505950]" : "hover:bg-[#c5ebe7]"} inline-flex items-center px-8 py-4 text-lg font-semibold`}
            >
      ...
      <style jsx global>{`
        /* Estilos eliminados para quitar sombras */
      `}</style>
    </section>
  )
}
