    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md mb-8">
          ...
          <Card className="w-full border border-custom-2/30 shadow-xl bg-backgroundSecondary/90 backdrop-blur-sm">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl font-bold text-center text-highlight">Acceso al Portal</CardTitle>
            ...
            <CardContent>
              {error && (
                <div className="bg-red-500/10 border border-red-500/50 text-red-500 px-4 py-2 rounded-md mb-4 text-sm">
                  {error}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <Link href="/forgot-password" className="text-xs text-highlight hover:underline">
              ...
              <div className="mt-6 p-4 bg-custom-1/30 rounded-md border border-custom-2/30">
                <h3 className="text-sm font-medium mb-2">Credenciales de demostración:</h3>
              ...
              <div className="mt-6">
                <div className="relative">
                  <div className="absolute inset-0 flex items-center">
                    <span className="w-full border-t border-custom-2/30"></span>
                  </div>
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-backgroundSecondary px-2 text-textMuted">O continúa con</span>
                  </div>
                </div>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <p className="text-xs text-textMuted text-center">
                ...
                y{" "}
                <Link href="/privacidad" className="text-highlight hover:underline">
